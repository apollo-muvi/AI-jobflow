...
| **🧪 QA** | deepseek / Claude | E2E 測試、功能驗證、文件手冊 | 測試、出報告 |
| **🚀 小p** | Pi4 | Docker 部署、CI/CD pipeline、Deployment Checklist、Cloudflare Tunnel、監控 | GitHub Issues → pull → build → deploy |
...
| **小p** (4GB + 512GB SSD) | 🚀 Deployer | 常開不關機、部署 CramAI 服務（Docker build + CI/CD）、Cloudflare Tunnel、系統備份、監控、Deployment Checklist |
